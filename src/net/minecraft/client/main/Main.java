...
public class Main
{
    public static void main(String[] p_main_0_)
    {
        ...
        //OptionSpec<String> optionspec18 = optionparser.accepts("userType").withRequiredArg().defaultsTo("mojang", new String[0]);
        ...
        //Session session = new Session("Spl1tdd3k@gmail.com", "f2ed5d57-cd22-47b4-95ba-e90981c9d740", "I@md1m1r" , "MOJANG");
