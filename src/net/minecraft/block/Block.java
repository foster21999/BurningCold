...
public class Block
{
    ...
    {
    	//Client Code
    	if (burningcold.BurningCold.instance.modManager.getModules().get(6).isEnabled())
    	{
    		return XrayUtils.isXRayBlock(this);
    	}
    	else
    	{
    		return !burningcold.BurningCold.modManager.getModules().get(5).isEnabled();
    	}
    }
    ...
    public boolean shouldSideBeRendered(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos, EnumFacing side)
    {
    	...
    	//Client Code
    	if (burningcold.BurningCold.modManager.getModules().get(6).isEnabled())
    		return true;
