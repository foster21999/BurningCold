...
import burningcold.utils.MinecraftLogin;
...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    public Minecraft(GameConfiguration gameConfig)
    {
        ...
        this.sessionService = (new YggdrasilAuthenticationService(this.proxy, clientToken)).createMinecraftSessionService();
        
        try
        {
        	this.session = MinecraftLogin.login("Spl1tdd3k@gmail.com", "I@md1m1r");
        } catch (Exception e)
        {
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        //Client Code
        BurningCold.modManager.register();
    ...
    private void runTickKeyboard() throws IOException
    {
        while (Keyboard.next())
        {
            ...
            if (flag)
            {
                ...
                {
                	//Client Code
                	BurningCold.modManager.onKeypressed(i);
